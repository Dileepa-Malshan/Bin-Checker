<?php
//==============[CC CHECKER BOT API MADE BY [🇱🇰]DILEEPA MALSHAN]================//

//=======[Webhook]========https://api.telegram.org/bot1917420727:AAF9RuwMqWfLh3wQTed_jrkJ-lsTLuGZPe4/setwebhook?url=<url>

//================[Telegram BOT API TOKEN ]================//
$botToken = "2116594653:AAGCq9qNUKPmLqEUTTxZ_K9WF77UAu95Ym4"; #<------------------- PUT YOUR TOKEN HERE------------->#
...
sendMessage($chatId, "GATEWAYS%0A%0A<b>STRIPE</b> [CVV/CCN] <code>/chk cc|mm|yy|cvv</code>%0A✅STATUS :- LIVE%0A%0A<b>SK [LIVE]</b> <code>/key sk_live</code>%0A✅STATUS :- LIVE%0A%0A<b>INFO</b> /info %0A✅STATUS :- LIVE%0A%0A<b>BIN [CHECK]</b> <code>/bin xxxxxx</code>%0A✅STATUS :- LIVE%0A%0ABOT MADE BY:- <b><i>[🇱🇰]DILEEPA MALSHAN</i></b>");
}
...
sendMessage($chatId, '<b>вιи:  </b>'.$bin.'%0A<b>⌬ Bank:</b> '.$bank.'%0A<b>⌬ Country:</b> '.$name.''.$emoji.'%0A<b>⌬ Brand:</b> '.$brand.'%0A<b>⌬ Card:</b> '.$scheme.'%0A<b>⌬ Type:</b> '.$type.'%0A<b>▬▬▬▬▬▬▬▬▬▬▬▬▬▬</b>%0A<b>⌬ CHECKED BY -</b>: @'.$username.'%0A<b>⌬ BOT BY</b>:<a> [🇱🇰]DILEEPA MALSHAN</a>', $message_id);
}
//=========[Bin Command-END]=========//
...
sendMessage($chatId, "✦ Chat [ID]: <code>$chatId</code>%0A✦ Name: $firstname%0A✦ Username: @$username%0A%0A✦<b>Bot Made by: [🇱🇰]DILEEPA MALSHAN</b>");
}
//=========[Info Command-END]=========//
...
sendMessage($chatId, "<b>🔴EXPIRED KEY</b>%0A<u>✦Key:</u> <code>$sec</code>%0A<b>✦Message: <b>Expired API key Provided%0A</b>✦Checked by:</b> @$username%0A<b>✦Bot Made by:[🇱🇰]DILEEPA MALSHAN</b>", $message_id);
}elseif (strpos($result, 'Invalid API Key provided')){
sendMessage($chatId, "<b>🔴INVALID KEY</b>%0A<b>✦Key:</b> <code>$sec</code>%0A<b>✦Message: <b>Invalid API Key provided.%0A</b>✦Checked by: </b>@$username%0A<b>✦Bot Made by:[🇱🇰]DILEEPA MALSHAN</b>", $message_id);
}
...
sendMessage($chatId, "<b>🔴NO KEY PROVIDED%0A✦Message:</b><b> You did not provide an API key.%0A</b><b>✦Checked by:</b> @$username%0A<b>✦Bot Made by:[🇱🇰]DILEEPA MALSHAN</b>", $message_id);
}
elseif ((strpos($result, 'testmode_charges_only')) || (strpos($result, 'test_mode_live_card'))){
sendMessage($chatId, "<b>🔴DEAD KEY</b>%0A<b>✦Key:</b> <code>$sec</code>%0A<b>✦Message: <b>Testmode charges only.%0A</b>✦Checked by:</b> @$username%0A<b>✦Bot Made by:[🇱🇰]DILEEPA MALSHAN</b>", $message_id);
}else{
sendMessage($chatId, "<b>🟢LIVE KEY</b>%0A<b>✦Key:</b><code>$sec</code>%0A<b>✦Message:<b> Live API key provided.%0A</b>✦Checked by:</b> @$username%0A<b>✦Bot Made by:[🇱🇰]DILEEPA MALSHAN</b>", $message_id);
}
}
